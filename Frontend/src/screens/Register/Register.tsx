...
import { container, captionText, avatarImage, highlightedText } from '@/styles/auth';
...
export default function Register() {
    ...
    const validateFields = () => {
        ...
        setIsButtonEnabled(isNameValid && isEmailValid && isPhoneValid && isPasswordValid && isConfirmPasswordValid);
    };
        ...
        >
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={container.base}>
                    ...
                    <AuthButton
                        label="Criar conta"
                        onPress={handleEmailVerification} // Navega para a tela de verificação de e-mail
                        // disabled={!isButtonEnabled} // Desabilita o botão se os campos não forem válidos
                        disabled={false}
                    />
                    <TouchableOpacity
                        activeOpacity={0.7}
                    ...
                    >
                        <Text style={captionText.base}>
                            Lembrou da sua conta? <Text style={highlightedText.base}>Login</Text>
                        </Text>
                    </TouchableOpacity>
                </View>
