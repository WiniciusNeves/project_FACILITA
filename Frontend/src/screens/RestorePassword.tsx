    ...
    return (
        <View style={container.base}>
            ...
            <View style={bulletList.base}>
                <Text style={[bulletList.bulletItem, requirements.minLength && bulletList.valid]}>
                    • Deve ter pelo menos 8 caracteres
                </Text>
                <Text style={[bulletList.bulletItem, requirements.uppercase && bulletList.valid]}>
                    • Deve conter pelo menos 1 letra maiúscula
                </Text>
                <Text style={[bulletList.bulletItem, requirements.number && bulletList.valid]}>
                    • Deve conter pelo menos 1 número
                </Text>
                <Text style={[bulletList.bulletItem, requirements.specialChar && bulletList.valid]}>
            ...
            />
            <AuthButton label="Próximo" onPress={handleSubmit} />
        </View>
    );
}
